...
var name = 'DasWetterAdapter';
var adapterName = 'daswetter';
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, adapter.getForeignStateAsync(instancePath + ".NextHours.Location_1.Day_1.current.temp_value")];
            case 2:
                observeTimeState = _a.sent();
                if (observeTimeState && typeof observeTimeState.ts) {
                    observeTime = new Date(observeTimeState.ts);
                    now = Date.now();
                ...
                throw new Error("Last Update to long ago (more than " + adapter.config.DasWetterAdapter_lastObeserveTimeSinceMinutes + " min), is the adapter still running and is it installed ?");
        }
    });
}); };
