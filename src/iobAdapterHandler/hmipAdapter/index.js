...
var name = 'HMIPAdapter';
var adapterName = 'hmip';
...
var rootLevelElementsCreator = function (adapter) { return __awaiter(void 0, void 0, void 0, function () {
    var rootLevel, rootLevelPath, rootLevelElements, returnStruct, _i, _a, rootObj, name_1, _b, deviceType, room, additionalNames;
    var _c, _d, _e, _f;
    return __generator(this, function (_g) {
        switch (_g.label) {
            ...
            case 1:
                rootLevelPath = _g.sent();
                return [4 /*yield*/, adapter.getForeignObjectsAsync(rootLevelPath + '.devices*', rootLevel)];
            case 2:
                rootLevelElements = _g.sent();
                returnStruct = [];
                if (rootLevelElements) {
                    for (_i = 0, _a = Object.values(rootLevelElements); _i < _a.length; _i++) {
                        rootObj = _a[_i];
                        name_1 = nameHelper_1["default"].getName((_d = (_c = rootObj.common) === null || _c === void 0 ? void 0 : _c.name) !== null && _d !== void 0 ? _d : '', (_f = (_e = adapter.systemConfig) === null || _e === void 0 ? void 0 : _e.language) !== null && _f !== void 0 ? _f : 'de');
                        _b = name_1.split(' '), deviceType = _b[0], room = _b[1], additionalNames = _b.slice(2);
