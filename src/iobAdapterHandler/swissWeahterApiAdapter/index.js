...
var name = 'SwissWeahterApiAdapter';
var adapterName = 'swiss-weather-api';
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                returnStruct = [];
                return [4 /*yield*/, adapter.getForeignObjectAsync(rootLevelPath + ".forecast.current_hour")];
            case 2:
                results = _b.sent();
                room = 'draussen';
                if (results) {
                    returnStruct.push({
                        ...
                        room: room,
                        additionalNames: [nameHelper_1["default"].getName((_a = results.common.name) !== null && _a !== void 0 ? _a : '')],
                        rootObj: results
                    });
                }
...
var SwissWeahterApiAdapter = {
    name: name,
    isHealth: isHealth,
    onMessageFunc: { getHealthStati: getHealthStati, rename: rename }
};
exports["default"] = SwissWeahterApiAdapter;
